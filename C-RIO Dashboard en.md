...
- [[#Real-Time-Dashboard|Real-Time-Dashboard]]
	- [[#Real-Time-Dashboard#System Tab|System Tab]]
		- [[#System Tab#Logging|Logging]]
		- [[#System Tab#FOCAS|FOCAS]]
		- [[#System Tab#CAN Monitor|CAN Monitor]]
		- [[#System Tab#Connection types|Connection types]]
			- [[#Connection types#Dashboard / OPC UA|Dashboard / OPC UA]]
			- [[#Connection types#Static / DI|Static / DI]]
			- [[#Connection types#First available /DI|First available /DI]]
		- [[#System Tab#Configuration of tools and processes|Configuration of tools and processes]]
		- [[#System Tab#OPC-UA Server Address|OPC-UA Server Address]]
	- [[#Real-Time-Dashboard#Raw Data View Tab|Raw Data View Tab]]
	- [[#Real-Time-Dashboard#Breakout detection Tab|Breakout detection Tab]]
		- [[#Breakout detection Tab#Breakout parameters|Breakout parameters]]
			- [[#Breakout parameters#Spindle speed|Spindle speed]]
			- [[#Breakout parameters#Order limit|Order limit]]
			- [[#Breakout parameters#Comb width|Comb width]]
			- [[#Breakout parameters#Number of teeth|Number of teeth]]
			- [[#Breakout parameters#Signal power limit|Signal power limit]]
	- [[#Real-Time-Dashboard#Stability tab|Stability tab]]
		- [[#Stability tab#IFT-Value|IFT-Value]]
		- [[#Stability tab#Overrides|Overrides]]
		- [[#Stability tab#Control indicators|Control indicators]]
		- [[#Stability tab#Controls for the rule|Controls for the rule]]
		- [[#Stability tab#Stability-Parameters|Stability-Parameters]]
			- [[#Stability-Parameters#Window length|Window length]]
			- [[#Stability-Parameters#Upper threshold|Upper threshold]]
			- [[#Stability-Parameters#Lower threshold|Lower threshold]]
			- [[#Stability-Parameters#Ramp|Ramp]]
			- [[#Stability-Parameters#Feed override|Feed override]]
			- [[#Stability-Parameters#Spindle override|Spindle override]]
			- [[#Stability-Parameters#Feed reduction factor|Feed reduction factor]]
			- [[#Stability-Parameters#Spindle reduction factor|Spindle reduction factor]]
			- [[#Stability-Parameters#Deadtime|Deadtime]]
			- [[#Stability-Parameters#Channels|Channels]]
			- [[#Stability-Parameters#IFT value factor|IFT value factor]]
			- [[#Stability-Parameters#IFT value offset|IFT value offset]]
		- [[#Stability tab#Modes|Modes]]
			- [[#Modes#WATCH|WATCH]]
			- [[#Modes#STABILITY 2 LEVEL|STABILITY 2 LEVEL]]
			- [[#Modes#STABILITY REDUCTION|STABILITY REDUCTION]]
			- [[#Modes#DIRECT OUTPUT|DIRECT OUTPUT]]
			- [[#Modes#STOP|STOP]]
	- [[#Real-Time-Dashboard#Example use-case|Example use-case]]
- [[#How to use the OPCUA-server of the SPU|How to use the OPCUA-server of the SPU]]
	- [[#How to use the OPCUA-server of the SPU#Connecting the OPCUA-Server|Connecting the OPCUA-Server]]
	- [[#How to use the OPCUA-server of the SPU#Visualisation of the variables|Visualisation of the variables]]
